...
>(({ className, children, apple = false, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex w-full items-center justify-between bg-transparent text-sm",
      ...
      apple
        ...
        : "h-10 rounded-md border border-input px-3 py-2 ring-offset-background focus:ring-2 focus:ring-ring focus:ring-offset-2",
      className
    )}
    {...props}
  >
