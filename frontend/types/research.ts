...
export interface ResearchInputs {
  ...
  /** 字数要求 */
  word_count: "1500字" | "3000字" | "5000字" | "8000字" | "13000字";
}
...
// 工作流节点配置 V5 稳定版（5个HTTP抓取 + 图表内嵌HTML）
export const WORKFLOW_NODES: NodeConfig[] = [
  { id: "2001", title: "开始", weight: 0.1, phase: 0 },
  { id: "20021", title: "HTTP抓取-Startpage", weight: 1, phase: 1 },
  { id: "20022", title: "HTTP抓取-Brave", weight: 1, phase: 1 },
  { id: "20023", title: "HTTP抓取-深度搜索", weight: 1, phase: 1 },
  { id: "20024", title: "HTTP抓取-Yahoo", weight: 1, phase: 1 },
  { id: "20025", title: "HTTP抓取-Ecosia", weight: 1, phase: 1 },
  { id: "2002", title: "研究规划", weight: 3, phase: 1 },
  { id: "2003", title: "信息整合与深度分析", weight: 6, phase: 2 },
  { id: "2004", title: "报告撰写", weight: 10, phase: 3 },
  { id: "2005", title: "HTML转换与图表嵌入", weight: 8, phase: 4 },
